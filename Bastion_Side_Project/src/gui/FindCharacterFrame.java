...
public class FindCharacterFrame extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(() -> {
			try {
				FindCharacterFrame frame = new FindCharacterFrame();
	...
	public FindCharacterFrame() {
		...
		table.setModel(new DefaultTableModel(new Object[][] {},
				new String[] { "Name", "Age", "Rank", "Location", "Occupation", "Currency" }));
		...
		btnFind.addActionListener(e -> searchCharacter());
	...
	private void searchCharacter() {
		...
		try {
			List<Characters> character = characterController.findCharacterByName(name);
			if (character != null) {
	...
	private void displayCharacter(List<Characters> characters) {
		...
		for (Characters character : characters) {
			model.addRow(new Object[] { character.getName(), character.getAge(), character.getMilitaryRank(),
					character.getLocation(), character.getOccupation(), character.getCurrency() });
		}
	}
