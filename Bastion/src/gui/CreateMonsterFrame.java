...
public class CreateMonsterFrame extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CreateMonsterFrame frame = new CreateMonsterFrame();
	 ...
	 * Create the frame.
	 */
	public CreateMonsterFrame() {

		try {
			mc = new MonsterController(); // Ensure this aligns with your ProductController implementation
		} catch (Exception e) {
		...
		JLabel lblNewLabel_2 = new JLabel("Lifespan");
		...
		JLabel lblNewLabel_3 = new JLabel("Classification");
		...
		JLabel lblNewLabel_5 = new JLabel("Habitat");
		...
		JLabel lblNewLabel_6 = new JLabel("Danger Level");
		...
		JLabel lblNewLabel_1 = new JLabel("Monster Creations");
	...
	private void addMonster(ActionEvent e) throws SQLException {
		String name = nameField.getText();
		String lifespan = ageField.getText();
		String classification = rankField.getText();
		String size = locationField.getText();
		String habitat = occupationField.getText();
		String danger = currencyField.getText();
		try {
			int life = Integer.parseInt(lifespan);
			double measurement = Double.parseDouble(size);
			Monster monster = new Monster(name, life, classification, measurement, habitat, danger);
			try {
				monster = mc.addMonster(monster);
				success("Success! Monster is added.");
			} catch (DataAccessException dae) {
				// e1.printStackTrace();
				complain("Data access error", "Could not insert new monster", dae);
			}
